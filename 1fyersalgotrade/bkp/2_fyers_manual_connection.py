...
client_id = "ABCDEF-100"            ## Client_id here refers to APP_ID of the created app
secret_key = "ABCDEF"               ## secret_key which you got after creating the app
...
fyers = fyersModel.FyersModel(token=access_token,is_async=False,client_id=client_id,log_path="C:/Users/aseem/Downloads/")
